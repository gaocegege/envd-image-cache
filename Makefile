# Copyright 2022 envd-image-cache Authors.
#
...
ROOT := github.com/tensorchord/envd-image-cache

# Target binaries. You can build multiple binaries for a single project.
TARGETS := envd-image-cache
...
addlicense: addlicense-install  ## Add license to GO code files
	addlicense -c "The envd-image-cache Authors" $$(find . -type f -name '*.go')
